...
--
-- Хост: 127.0.0.1
-- Время создания: Май 31 2021 г., 23:34
...
(13, 'Иван', 'Иваныч', 'Иванов', '904e0a66bbcfa20e551a0788c5b69cfe', '', '3_0550000_00120', '2021-05-06', '1'),
(22, 'Игнатик', 'Терешков', 'Магамедович', 'г. Петрозаводск, ул. Колотушкина, 9А, 2', '574-122-123 00', '1_0000000_00021', '1999-08-05', '+79234510111'),
(24, 'Пупки', 'Пупкин', 'Пупппп', 'наб Варкауса, 33, 21', '123-456-678 00', '1_0000000_00000', '2222-01-02', '+79214510472'),
(25, 'Илья', 'Ильин', 'Ильич', 'наб Варкауса, 33, 77', '123-456-119 00', '1_0000000_00033', '2222-01-02', '+79214510666');
...
(9, 'Test', '3d3f8cccfb49375736b395eab9405472', 'Васька', 'Фамилия', 'Никитич', 0, '2021-04-14', ''),
...
--
ALTER TABLE `programs`
  MODIFY `program_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `userproglink`
  MODIFY `link_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
